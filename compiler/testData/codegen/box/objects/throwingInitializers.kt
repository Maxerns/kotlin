...
//        if (e.message != "Could not initialize class O") return "FAIL 7.3: unexpected message: '${e.message}'"
    }
...
//        if (e.message != "Could not initialize class ThrowsErrorWithCompanion") return "FAIL 9.3: unexpected message: '${e.message}'"
    }
...
//        if (e.message != "Could not initialize class ThrowsErrorObject") return "FAIL 11.3: unexpected message: '${e.message}'"
    }
