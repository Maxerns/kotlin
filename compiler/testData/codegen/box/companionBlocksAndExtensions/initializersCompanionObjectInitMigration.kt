...
// JVM_IR and Native initialize the second companion block before the companion
...
fun box(): String {
    ...
    if (initLog != "ABIC") return "FAIL order after object access: $initLog"

    if (Mixed.beforeObject != "before") return "FAIL before"
    if (Mixed.afterObject != "after") return "FAIL after"
    if (Mixed.Companion.objectValue != "object") return "FAIL companion object"
