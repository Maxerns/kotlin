...
fun box() = abiTest {
    ...
    expectFailure(linkage("Constructor 'RemovedClass.<init>' can not be called: No constructor found for symbol '/RemovedClass.<init>'")) { Container().callInlineFunExistingAnyOverloadWithRemovedClass() }
}
