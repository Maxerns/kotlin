...
class WasmCallableReferenceLowering(val backendContext: WasmBackendContext) : FileLoweringPass {
    ...
    private fun createOrGetFunctionReferenceClass(functionReference: IrRichFunctionReference, irFile: IrFile): IrClass {
        ...
        // Later Function will be checked for Continuation type arguments - we need it
        // to survive this stage. This is done by assigning a different key to the functions
        // carrying Continuation.
        // Without it, representative chose by keying `fileLocalClassCache` may not carry Continuation parameter type.
        //
        // Reference A:
